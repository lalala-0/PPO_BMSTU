...
func (m *MockICrewRepository) GetCrewDataBySailNumAndRatingID(num int) (*models.Crew, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCrewDataBySailNumAndRatingID", num)
	ret0, _ := ret[0].(*models.Crew)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockICrewRepositoryMockRecorder) GetCrewDataBySailNumAndRatingID(num any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCrewDataBySailNumAndRatingID", reflect.TypeOf((*MockICrewRepository)(nil).GetCrewDataBySailNumAndRatingID), num)
}

// GetCrewsDataByRatingID mocks base method.
func (m *MockIParticipantRepository) GetCrewsDataByRatingID(id uuid.UUID) ([]models.Crew, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIParticipantRepositoryMockRecorder) GetCrewsDataByRatingID(id uuid.UUID) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCrewsDataByRatingID", reflect.TypeOf((*MockIParticipantRepository)(nil).GetCrewsDataByRatingID), id)
}

// GetCrewsDataByProtestID mocks base method.
func (m *MockIParticipantRepository) GetCrewsDataByProtestID(id uuid.UUID) ([]models.Crew, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIParticipantRepositoryMockRecorder) GetCrewsDataByProtestID(id uuid.UUID) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCrewsDataByProtestID", reflect.TypeOf((*MockIParticipantRepository)(nil).GetCrewsDataByProtestID), id)
}
...
func (mr *MockICrewRepositoryMockRecorder) ReplaceParticipantStatusInCrew(crewID, participantID, helmsman, active any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AttachParticipantToCrew", reflect.TypeOf((*MockICrewRepository)(nil).ReplaceParticipantStatusInCrew), crewID, participantID, helmsman, active)
}
