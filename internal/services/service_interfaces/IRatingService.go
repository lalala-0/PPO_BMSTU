...
type IRatingService interface {
	AddNewRating(ratingID uuid.UUID, class int, blowoutCnt int) (*models.Rating, error)
	DeleteRatingByID(id uuid.UUID) error
	UpdateRatingByID(ratingID uuid.UUID, class int, blowoutCnt int) (*models.Rating, error)
