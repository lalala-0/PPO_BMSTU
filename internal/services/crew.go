...
func (c CrewService) AddNewCrew(crewID uuid.UUID, ratingID uuid.UUID, class string, sailNum int) (*models.Crew, error) {
...
func (c CrewService) DeleteCrewByID(id uuid.UUID) error {
	...
	if err != nil {
		...
		return fmt.Errorf("SERVICE: GetCrewDataByID method faile")
	}
...
func (c CrewService) UpdateCrewByID(crewID uuid.UUID, ratingID uuid.UUID, class string, sailNum int) (*models.Crew, error) {
