...
import { useUpdateCrew } from "../../controllers/crewControllers/updateCrewController"; // Путь к твоему хук-файлу
import api from "../../controllers/api"; // Путь к твоему мокированному API
